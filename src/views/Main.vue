  ...
  <div id="main">
    ...
    <div class="publicbox">
                ...
                <div class="bottom">
                    ...
                    <sui-button  positive size="medium">Text</sui-button>
                </div>
            </div>
            ...
            <div class="privatebox">
                ...
                <div class="private">
                    ...
                    <p class="toppic">fsdfsdfsdfsdfsdfssdflkojipoiwepoirflkjsdjofsd;ljifasfe;jewo;ipjfwe;oflijwefj;oipkdlsjf;ajweifjdfsdfsdf</p>
                </div>
                <div class="Replay">
    ...
    <div class="mainbar">
        ...
        <div class="C" @click="select">Course</div>
